...
<head>
  ...
  *,*::before,*::after{ box-sizing:border-box }
  ...
  /* 현재 위치 강조(봉사 신청 내역) */
  aside a[href="volunteer-list.jsp"]{
  ...
  section > div:first-of-type button::before{
    content:"⏳"; font-size:14px; /* 필터 아이콘 느낌 */
  }
  ...
  /* ===== 카드(각 신청) =====
     구조: article > [정보div] [상태span] [우측버튼들div] */
  ...
  /* 좌측 정보 블록에 캘린더 아이콘 박스(의사요소) */
  section > div:nth-of-type(2) article > div:first-child{
    position:relative; padding-left:52px;
  }
  section > div:nth-of-type(2) article > div:first-child::before{
    content:"📅";
    position:absolute; left:0; top:50%; transform:translateY(-50%);
    width:36px; height:36px; border-radius:10px;
    display:flex; align-items:center; justify-content:center;
    background:#F7F3EE; border:1px solid #ECE4DA; font-size:18px;
    color:#8C7763;
  }
  ...
  section > div:nth-of-type(2) article button:hover{ background:#FCEEEE; }
    ...
    <section>
      ...
      <div>
        <article>
          <div>
            <p>산책 봉사</p>
            <div>행복보호소 · 2024.02.03 · 14:00–17:00</div>
          </div>
          <span>승인됨</span>
          <div>
            <a href="#">상세보기</a>
        ...
        <article>
          <div>
            <p>보호소 청소</p>
            <div>사랑보호소 · 2024.02.10 · 10:00–14:00</div>
          </div>
          <span>대기중</span>
          <div>
            <a href="#">상세보기</a>
